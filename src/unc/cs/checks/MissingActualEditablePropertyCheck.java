...
public  class MissingActualEditablePropertyCheck extends AbstractActualPropertyCheck {
     ...
     * file.
     */
    public static final String MSG_KEY = "missingActualEditableProperty";
...
//	}
    ...
    public Boolean checkActualProperty (STType anSTType, String aDeclarePropertyName ) {
    	return anSTType.hasActualEditableProperty(aDeclarePropertyName);
    }
	@Override
